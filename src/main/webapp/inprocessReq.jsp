...
<div class="card shadow mt-5">
    <div class="card-body">
        ...
        <h4 class="p-2" style="border-bottom: 2px solid green;">In Process Request</h4>
            ...
            <table id="example" class="table table-striped table-bordered">
                ...
                <%
							try {
								...
								ResultSet rs = st.executeQuery("select * from requests where Status='Request is inprocess'");
								int i = 0;
								while (rs.next()) {
									i++;
						%>
