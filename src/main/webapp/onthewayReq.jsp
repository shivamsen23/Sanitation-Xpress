...
<title>On the way Request</title>
</head>
<body>
	...
	<div class="card shadow mt-5">
		<div class="card-body">
			...
			<h4 class="p-2" style="border-bottom: 2px solid green;">Team on the way Request</h4>
					...
					<tbody>
						<%
							try {
								...
								ResultSet rs = st.executeQuery("select * from requests where Status='Team On The Way'");
								int i = 0;
								while (rs.next()) {
									i++;
						%>
