...
<body>
	...
	<header id="header" class="fixed-top">
		<div class="container d-flex align-items-center">
			...
			<h1 class="logo me-auto">
				<a href="{% url 'index' %}"><span style="color: red">S</span>anitization
	...
	<!-- End Breadcrumbs --> <!-- ======= About Section ======= -->
	<section id="about" class="about">
		<div class="container mt-5">
			<form name="search" method="post" action="track.jsp">

				<!-- Jumbotron Header -->
				<div class="card my-4" style="border: 2px ridge green">
					<h5 class="card-header text-info">Track your request by
						given request number or mobile number</h5>
					<div class="card-body">
						<div class="input-group">
							<input type="text" class="form-control" name="search"
								placeholder="Enter Request No/Mobile number ..." required="true">
